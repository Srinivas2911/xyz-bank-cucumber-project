...
WebElement _homePageBtn;
    ...
    public void clickOnAddCustomerTab() {
        Reporter.addStepLog("Clicking on Add Customer Tab: " + _addCustomerTab.toString() + "<br>");
        clickOnElement(_addCustomerTab);
        log.info("Clicking on Add Customer Tab: " + _addCustomerTab.toString());
    }
    public void clickOnOpenAccountTab() {
        Reporter.addStepLog("Clicking on Open Account Tab: " + _openAccountTab.toString() + "<br>");
    ...
    public void clickOnCustomersTab() {
        Reporter.addStepLog("Clicking on Customers Tab: " + _customersTab.toString() + "<br>");
